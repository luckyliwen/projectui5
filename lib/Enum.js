sap.ui.define([], function() {
	...
	return {
		...
		ActionFlag: {
			Submit: "Submit", Approve: "Approve", Promote: "Promote", Cancel: "Cancel", Others: "Others"
		},
		...
		CommonItems: [
			...
			{mandatory: true, name: "Id Or Passport", property: 'IdOrPassort', type: 'Input', label: 'Id Or Passport', 
			...
			{mandatory: true, name: "Department", property: 'Department', type: 'List', label: 'Department', tooltip: 'Department',
				candidate: "DBS;GCO;P&I;HR;GFA;IT;oCEO (Marketing, CA, GR, GPO PSD, GPO OEM…);Business Network;Others"},
			...
			{mandatory: true, name: "License Agreement", property: 'Agreement', type: 'Agreement', label: 'License Agreement', 
